...
When a diff contains multiple changes (e.g., added validation AND error message improvements), identify the **primary intent** that drives the change. Use that as the focus of your single-line message. Secondary changes are supporting details, not separate concerns.
